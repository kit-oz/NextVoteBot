...
MESSAGES = {
    ...
    "VOTE_OK": "You voted for '{}'.",
    "VOTE_CHANGE_ANSWER": "You changed your vote to '{}'.",
    "VOTE_POLL_CLOSED": "Sorry, this poll is closed",
    "VOTE_ALREADY_ANSWERED": "You already vote in this poll",
}
